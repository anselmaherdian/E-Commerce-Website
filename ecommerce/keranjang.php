        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <div class="d-flex align-items-center gap-3 p-3 border-bottom">
                    <div style="width:70px;height:70px;background:#f0f4f8;border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                        <?php if ($item['gambar'] && file_exists('uploads/'.$item['gambar'])): ?>
                            <img src="uploads/<?= $item['gambar'] ?>" width="70" height="70" style="object-fit:cover;border-radius:10px;">
                        <?php else: ?>
